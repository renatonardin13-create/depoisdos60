    ...
    <section className="relative overflow-hidden pt-6 pb-16 md:pt-10 md:pb-24 bg-gradient-to-b from-[#052119] via-[#083024] to-[#041a13] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          {/* Left Column: Headlines, key points, countdown, CTA */}
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-[2.9rem] font-extrabold text-white tracking-tight leading-[1.18]">
              Depois dos 60:{' '}
            ...
            {/* Mobile/Tablet Only Mockup (Shown right under subheadline on small screens) */}
            ...
            <div className="pt-2 space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-center lg:justify-start gap-3.5">
                <button
                  id="hero-primary-cta"
                  type="button"
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-y-2.5 gap-x-5 text-xs sm:text-sm text-emerald-200/90 pt-1">
                ...
                <div className="w-full text-[11px] sm:text-xs text-emerald-200/90 pt-0.5 text-center lg:text-left">
              ...
              <div className="pt-3 flex flex-wrap items-center justify-center lg:justify-start gap-3 border-t border-emerald-800/60">
              ...
              {/* Trust Badges Strip */}
              <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-4 text-[11px] text-emerald-300/80">
          ...
          {/* Right Column (Desktop Only): 3D Box & Smartphone Bundle Mockup */}
